...
(function ($) {
    ...
    var htmlParser = function (timerObject, options, format) {
         ...
         */
        var counter_years = '<div class="years"><span class="count">' + timerObject.years +
            '</span><span class="title">' + (timerObject.years > 1 ? options.regional.years : options.regional.year) +
            '</span></div>';
        var counter_days = '<div class="days"><span class="count">' + timerObject.days +
            '</span><span class="title">' + (timerObject.days > 1 ? options.regional.days : options.regional.day) +
            '</span></div>';
        var counter_hours = '<div class="hours"><span class="count">' + timerObject.hours +
            '</span><span class="title">' + (timerObject.hours > 1 ? options.regional.hours : options.regional.hour) +
            '</span></div>';
        var counter_minutes = '<div class="minutes"><span class="count">' + timerObject.minutes +
            '</span><span class="title">' + (timerObject.minutes > 1 ? options.regional.minutes : options.regional.minute) +
            '</span></div>';
        var counter_seconds = '<div class="seconds"><span class="count">' + timerObject.seconds +
            '</span><span class="title">' + (timerObject.seconds > 1 ? options.regional.seconds : options.regional.second) +
            '</span></div>';
